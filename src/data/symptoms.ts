...
/** Inline SVG icon strings â line style, 26Ã26 display, 24Ã24 viewBox, stroke-width 1.75 */
const S = (d: string) =>
...
const ICONS: Record<string, string> = {
  ...
  // gift: warning triangle with exclamation point
  ...
  // schmerz: sun/starburst (pain radiating)
...
export const SYMPTOMS: Symptom[] = [
  ...
  { id: 'urin_katze',   label: 'Kann nicht urinieren',   icon: ICONS.urin_katze, species: 'katze' },
  { id: 'schmerz',      label: 'Starke Schmerzen',       icon: ICONS.schmerz },
  { id: 'schwaeche',    label: 'SchwÃ¤che / Apathie',     icon: ICONS.schwaeche },
